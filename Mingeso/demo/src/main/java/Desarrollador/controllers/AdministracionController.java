...
public class AdministracionController {
    ...
    public String listar(Model model) {
        ArrayList<AdministracionEntity> administracion = administracionService.obtenerReporte();
    ...
    */
    @GetMapping("/reporte")
    private String reporte(){return "/reporte";}

    /*
    @PostMapping("/reporte")
    public String crearReporte(@RequestParam("quincena") String quincena,
        ...
        administracionService.guardarAdministracion(quincena, codigo_proveedor, nombre_proveedor, total_kls_leche,
                                                    nro_dias_envio_leche, promedio_kls_leche, variacion_leche, grasa,
                                                    variacion_grasa, solidos_totales, variacion_solidos_totales, pago_leche,
                                                    pago_grasa, pago_solidos_totales, bonificacion_frecuencia,
                                                    descuento_variacion_leche, descuento_variacion_grasa, descuento_variacion_solidos,
